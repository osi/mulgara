...
CLASSPATH=${CLASSPATH}:lib/ant-1.6.1.jar:lib/bsf-2.3.0.jar
CLASSPATH=${CLASSPATH}:lib/ant-launcher-1.6.1.jar:lib/junit-3.8.1.jar
CLASSPATH=${CLASSPATH}:lib/ant-junit-1.6.1.jar:lib/ant-apache-bsf-1.6.1.jar
CLASSPATH=${CLASSPATH}:lib/ant-trax-1.6.1.jar
CLASSPATH=${CLASSPATH}:lib/js-1.5r3.jar:lib/ant-nodeps-1.6.1.jar
