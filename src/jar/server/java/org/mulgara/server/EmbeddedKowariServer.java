...
import org.kowari.config.ExternalConfigPaths;
import org.kowari.config.Jetty;
import org.kowari.config.TucanaConfig;
import org.kowari.config.Listener;
 ...
 */
public class EmbeddedKowariServer extends Thread {
   ...
   */
  private TucanaConfig config = null;
  ...
  static {
    ...
    log = Logger.getLogger(EmbeddedKowariServer.class.getName());
   ...
   */
  protected EmbeddedKowariServer() {
   ...
   */
  private EmbeddedKowariServer(ServerMBean server, Server httpServer) {
  ...
  public static void setBoundHostname(String boundHostname) {
    EmbeddedKowariServer.boundHostname = boundHostname;
  ...
  public static SessionFactory getLocalSessionFactory() {
    ...
    return EmbeddedKowariServer.localSessionFactory;
  ...
  public static String getBoundHostname() {
    return EmbeddedKowariServer.boundHostname;
  }
  ...
  private static void setServerURI(URI serverURI) {
    EmbeddedKowariServer.serverURI = serverURI;
  ...
  public static void main(String[] args) {
    ...
    EmbeddedKowariServer server = new EmbeddedKowariServer();
    EmbeddedKowariOptionParser optsParser =
        new EmbeddedKowariOptionParser(args);
      ...
      if (startServer) {
        ...
        if (log.isInfoEnabled()) {
          ...
          log.info("Successfully started Kowari server at " +
              EmbeddedKowariServer.getServerURI().toString() +
              " in directory " +
  ...
  public static void shutdown(String[] args) {
    ...
    // get the socket port
    int port = EmbeddedKowariServer.getShutdownHookPort();
    ...
    try {
      ...
      toServer.println(EmbeddedKowariServer.SHUTDOWN_MSG);
      toServer.flush();
      toServer.close();
    }
  ...
  private static void setLocalSessionFactory(SessionFactory localSessionFactory) {
    ...
    EmbeddedKowariServer.localSessionFactory = localSessionFactory;
  ...
  protected static void setRMIPort(int rmiPort) {
    ...
    EmbeddedKowariServer.rmiPort = rmiPort;
  ...
  public static int getRMIPort() {
    ...
    return EmbeddedKowariServer.rmiPort;
  }
  ...
  private static int getShutdownHookPort() {
    ...
    int port = EmbeddedKowariServer.SHUTDOWN_PORT;
  ...
  protected void configureSystemProperties() throws IOException {
    ...
    if (System.getProperty("no_rmi") == null) {
      ...
      try {
        ...
        // start the registry
        LocateRegistry.createRegistry(EmbeddedKowariServer.getRMIPort());

        if (log.isInfoEnabled()) {

          log.info("RMI Registry started automatically on port " +
              EmbeddedKowariServer.getRMIPort());
        }
  ...
  public static void setHttpPort(int httpPort) {
    ...
    EmbeddedKowariServer.httpPort = httpPort;
  ...
  public static int getHttpPort() {
    ...
    return EmbeddedKowariServer.httpPort;
  } // getHttpPort()
   ...
   */
  public boolean configure(EmbeddedKowariOptionParser parser) {
    ...
    try {
      ...
      if (parser.getOptionValue(EmbeddedKowariOptionParser.HELP) != null) {
        ...
        Object configURL =
            parser.getOptionValue(EmbeddedKowariOptionParser.SERVER_CONFIG);
        ...
        */
        ...
        TucanaConfig config =
            TucanaConfig.unmarshal(new InputStreamReader(
            (new URL( (String) configURL)).openStream()));
        config.validate();
        this.setConfig(config);

        // disable automatic starting of the RMI registry
        if (parser.getOptionValue(EmbeddedKowariOptionParser.NO_RMI) != null) {
        ...
        Object host =
            parser.getOptionValue(EmbeddedKowariOptionParser.SERVER_HOST);
        ...
        Object rmiPort =
            parser.getOptionValue(EmbeddedKowariOptionParser.RMI_PORT);

        if (rmiPort != null) {

          EmbeddedKowariServer.setRMIPort(Integer.parseInt((String) rmiPort));
        }
        else {

          EmbeddedKowariServer.setRMIPort(this.getConfig().getRMIPort());
        }
        ...
        Object loggingConfig =
            parser.getOptionValue(EmbeddedKowariOptionParser.LOG_CONFIG);

        if (loggingConfig != null) {

          EmbeddedKowariServer.loadLoggingConfig(new URL( (String)
              loggingConfig));
        }
        else {

          EmbeddedKowariServer.loadLoggingConfig(config.
        ...
        Object httpHost =
            parser.getOptionValue(EmbeddedKowariOptionParser.HTTP_HOST);
        ...
        Object httpPort =
            parser.getOptionValue(EmbeddedKowariOptionParser.PORT);
        ...
        Object serverName =
            parser.getOptionValue(EmbeddedKowariOptionParser.SERVER_NAME);
        ...
        Object persistencePath =
            parser.getOptionValue(EmbeddedKowariOptionParser.PERSISTENCE_PATH);
        ...
        Object smtpServer =
            parser.getOptionValue(EmbeddedKowariOptionParser.SMTP_SERVER);
  ...
  public void startServer() throws IOException, NamingException,
    ...
    EmbeddedKowariServer.setLocalSessionFactory(this.getSessionFactory());

    // set the server uri.
    EmbeddedKowariServer.setServerURI(((AbstractServer) this.getServer()).getURI());
    ...
    public void run() {
      ...
      try {
        ...
        while (!stop) {
          ...
          if ( (message != null) &&
              message.equals(EmbeddedKowariServer.SHUTDOWN_MSG)) {
