 ...
 */
public class EmbeddedKowariOptionParser extends CmdLineParser {
  ...
  private final static Category log =
      Category.getInstance(EmbeddedKowariOptionParser.class.getName());
   ...
   */
  public EmbeddedKowariOptionParser(String[] args) {
