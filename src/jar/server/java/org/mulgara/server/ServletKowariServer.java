 ...
 */
public class ServletKowariServer extends HttpServlet implements
    SingleThreadModel {
   ...
   */
  private final static Logger log = Logger.getLogger(ServletKowariServer.class
      .getName());
  ...
  public static void setDatabase(Database database) {
    ...
    ServletKowariServer.database = database;
  ...
  public static Database getDatabase() {
    ...
    return ServletKowariServer.database;
  }
  ...
  public void init() throws ServletException {
    ...
    try {
      ...
      String log4jConfigPath = this
          .getRealPath(ServletKowariServer.KOWARI_LOG4J_CONFIG);
    ...
    if (ServletKowariServer.getDatabase() == null) {
      ...
      ServletKowariServer.setDatabase(this.createDatabase());
    }
  ...
  private void configureSystemProperties() throws IOException {
    ...
    String luceneIndex = this.getServletContext().getInitParameter(
        ServletKowariServer.LUCENE_INDEX_DIR);

    if (luceneIndex != null) {

      System.setProperty(ServletKowariServer.LUCENE_INDEX_DIR, luceneIndex);
