 ...
 */
public class ThingJRDFKowariImplUnitTest extends ThingJRDFMemoryImplUnitTest {
...
//        }
   ...
   * @param arg0 String
   */
  public ThingJRDFKowariImplUnitTest(String arg0) {
    super(arg0);
  ...
  protected void initRDFKowariImpl() throws Exception {
    ...
    try {
      ...
      graphURI = new URI("rmi", hostname, "/" + SERVER_NAME, "testThingKowari");
