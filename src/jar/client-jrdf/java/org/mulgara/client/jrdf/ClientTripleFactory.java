 ...
 *
 * @modified $Date: 2005/01/27 11:31:50 $
 *
...
public class ClientTripleFactory extends AbstractTripleFactory {
  ...
  /**
   * Constructor. Validates and initializes Graph and Graph's GraphElementFactory.
   *
   */
  public ClientTripleFactory(Graph graph) {
    ...
    //cannot proceed without a valid graph
    if (graph == null) {

      throw new IllegalArgumentException("Graph cannot be null.");
    }

    //graph must have a valid Element Factory
    if (graph.getElementFactory() == null) {

      throw new IllegalArgumentException("Graph cannot have a null " +
                                         "GraphElementFactory.");
    }
