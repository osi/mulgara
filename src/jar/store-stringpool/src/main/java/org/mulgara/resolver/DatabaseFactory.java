...
public abstract class DatabaseFactory {
  ...
  static void configure(Database database, MulgaraConfig config) throws InitializerException, SecurityAdapterFactoryException {
    ...
    Enumeration<? extends org.mulgara.config.ContentHandler> contentHandlers = config.enumerateContentHandler();
    ...
    Enumeration<? extends org.mulgara.config.ResolverFactory> resolverFactories = config.enumerateResolverFactory();
    ...
    Enumeration<? extends org.mulgara.config.SecurityAdapterFactory> securityAdapterFactories = config.enumerateSecurityAdapterFactory();
    ...
    Enumeration<? extends RuleLoader> ruleLoaders = config.enumerateRuleLoader();
