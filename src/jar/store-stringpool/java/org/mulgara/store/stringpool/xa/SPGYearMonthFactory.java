...
/**
 * Factory class to create instances of SPGYearMonth objects.
 *
 * @created 2004-10-06
 *
 * @author Mark Ludlow
...
public final class SPGYearMonthFactory implements SPTypedLiteralFactory {
  ...
  public int getTypeId() {
    ...
    return SPGYearMonthImpl.TYPE_ID;
  }
  ...
  /**
   * Creates an instance of a gYearMonth typed literal based on the lexical form.
   *
   * @param typeURI The type URI of the lexical form
   * @param lexicalForm The lexical form of the literal
   *
   * @return The typed literal, gYearMonth instance
   */
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {

    assert SPGYearMonthImpl.TYPE_URI.equals(typeURI);
    return SPGYearMonthImpl.newInstance(lexicalForm);
  }

  /**
   * Creates an instance of a gYearMonth typed literal based on the content of a byte
   * buffer.
   *
  ...
  public SPTypedLiteral newSPTypedLiteral(int subtypeId, ByteBuffer data) {
    ...
    assert subtypeId == 0;
    return new SPGYearMonthImpl(data);
  }
