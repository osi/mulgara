...
/**
 * Factory class to create instances of SPGDay objects.
 *
 * @created 2004-10-06
 *
 * @author Mark Ludlow
...
public final class SPGDayFactory implements SPTypedLiteralFactory {
  ...
  /**
   * Creates an instance of a gDay typed literal based on the lexical form.
   *
   * @param typeURI The type URI of the lexical form
   * @param lexicalForm The lexical form of the literal
   *
   * @return The typed literal, gDay instance
   */
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {

    assert SPGDayImpl.TYPE_URI.equals(typeURI);
    return SPGDayImpl.newInstance(lexicalForm);
  }

  /**
   * Creates an instance of a gDay typed literal based on the content of a byte
   * buffer.
   *
