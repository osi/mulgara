...
/**
 * A factory for SPXSDStringImpl objects.
 *
 * @created 2004-10-05
 *
...
public final class SPXSDStringFactory implements SPTypedLiteralFactory {
  ...
  public int getTypeId() {
    return SPXSDStringImpl.TYPE_ID;
  }
  ...
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {
    assert SPXSDStringImpl.TYPE_URI.equals(typeURI);
    return new SPXSDStringImpl(lexicalForm);
  }


  public SPTypedLiteral newSPTypedLiteral(int subtypeId, ByteBuffer data) {
    assert subtypeId == 0;
    return new SPXSDStringImpl(data);
  }
