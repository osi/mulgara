...
/**
 * A factory for SPFloatImpl objects.
 *
 * @created 2004-10-05
 *
...
public final class SPFloatFactory implements SPTypedLiteralFactory {
  ...
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {
    assert SPFloatImpl.TYPE_URI.equals(typeURI);
    return new SPFloatImpl(lexicalForm);
  }


  public SPTypedLiteral newSPTypedLiteral(int subtypeId, ByteBuffer data) {
    assert subtypeId == 0;
    return new SPFloatImpl(data);
  }
