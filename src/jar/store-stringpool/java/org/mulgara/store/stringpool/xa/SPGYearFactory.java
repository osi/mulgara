...
/**
 * Factory class to create instances of SPGYear objects.
 *
 * @created 2004-10-04
 *
 * @author Mark Ludlow
...
public final class SPGYearFactory implements SPTypedLiteralFactory {
  ...
  /**
   * Creates an instance of a gYear typed literal based on the lexical form.
   *
   * @param typeURI The type URI of the lexical form
   * @param lexicalForm The lexical form of the literal
   *
   * @return The typed literal, gYear instance
   */
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {

    assert SPGYearImpl.TYPE_URI.equals(typeURI);
    return SPGYearImpl.newInstance(lexicalForm);
  }

  /**
   * Creates an instance of a gYear typed literal based on the content of a byte
   * buffer.
   *
