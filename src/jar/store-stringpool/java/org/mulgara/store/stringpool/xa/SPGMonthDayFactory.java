...
/**
 * Factory class to create instances of SPGMonthDay objects.
 *
 * @created 2004-10-06
 *
 * @author Mark Ludlow
...
public final class SPGMonthDayFactory implements SPTypedLiteralFactory {
  ...
  public int getTypeId() {
    ...
    return SPGMonthDayImpl.TYPE_ID;
  }
  ...
  /**
   * Creates an instance of a gMonthDay typed literal based on the lexical form.
   *
   * @param typeURI The type URI of the lexical form
   * @param lexicalForm The lexical form of the literal
   *
   * @return The typed literal, gMonthDay instance
   */
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {

    assert SPGMonthDayImpl.TYPE_URI.equals(typeURI);
    return SPGMonthDayImpl.newInstance(lexicalForm);
  }

  /**
   * Creates an instance of a gMonthDay typed literal based on the content of a byte
   * buffer.
   *
  ...
  public SPTypedLiteral newSPTypedLiteral(int subtypeId, ByteBuffer data) {
    ...
    assert subtypeId == 0;
    return new SPGMonthDayImpl(data);
  }
