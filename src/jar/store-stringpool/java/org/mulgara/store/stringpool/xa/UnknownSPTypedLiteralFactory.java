...
/**
 * Factory for creating datatyped literal objects of a type we don't natively
 * support.
 *
 * @created 2004-12-08
 *
  ...
  implements SPTypedLiteralFactory
{
  ...
  public SPTypedLiteral newSPTypedLiteral(URI typeURI, String lexicalForm) {
    return new UnknownSPTypedLiteralImpl(lexicalForm, typeURI);
  }

  public SPTypedLiteral newSPTypedLiteral(int subtypeId, ByteBuffer data) {
    assert subtypeId == 0;
    return new UnknownSPTypedLiteralImpl(data);
  }
}
