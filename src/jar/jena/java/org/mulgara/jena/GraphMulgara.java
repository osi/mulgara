...
public class GraphMulgara extends GraphBase {
  ...
  private final static Logger logger =
      Logger.getLogger(GraphMulgara.class.getName());
   ...
   * Reification graph.
   */
  private GraphMulgara reificationGraph;
   ...
   *   are null.
   */
  public GraphMulgara(LocalJenaSession existingDatabaseSession, URI newGraphURI)
   ...
   *   are null.
   */
  private GraphMulgara(LocalJenaSession existingDatabaseSession, URI newGraphURI,
  ...
  public void init(LocalJenaSession existingDatabaseSession, URI newGraphURI,
    ...
    try {
      ...
      if (!isReificationGraph) {
        reificationGraph = new GraphMulgara(session, new URI(graphURI + "_ref"),
    ...
    transactionHandler = new MulgaraTransactionHandler(session);
    bulkUpdateHandler = new MulgaraBulkUpdateHandler(this);
    capabilities = new MulgaraCapabilities();
  }
   ...
   */
  public GraphMulgara getReificationGraph() {
    return reificationGraph;
  }

  /**
   * Returns this Graph's transaction handler - currently
   * {@link org.mulgara.jena.MulgaraTransactionHandler}
   *
  ...
  public Reifier getReifier() {
    if (reifier == null) {
      reifier = MulgaraReifier.create(this, style);
    }
    return reifier;
  }
  ...
  public QueryHandler queryHandler() {
    if (queryHandler == null) {
      queryHandler = new MulgaraQueryHandler(session, this);
    }
    return queryHandler;
  }
   ...
   * {@link org.mulgara.jena.MulgaraBulkUpdateHandler}
   *
   ...
   * {@link org.mulgara.jena.MulgaraCapabilities}
   *
   * @return this Graph's transaction handler  - currently
   * {@link org.mulgara.jena.MulgaraCapabilities}
   */
