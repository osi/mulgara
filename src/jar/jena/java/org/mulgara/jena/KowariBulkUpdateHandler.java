 ...
 */
public class KowariBulkUpdateHandler implements BulkUpdateHandler {

  /**
   * Logger. This is named after the class.
   */
  private final static Logger logger =
      Logger.getLogger(KowariBulkUpdateHandler.class.getName());
   ...
   */
  public KowariBulkUpdateHandler(GraphKowari newGraphKowari) {
