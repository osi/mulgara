 ...
 */
public class ModelKowariMaker extends ModelMakerImpl implements ModelMaker {
   ...
   */
  public ModelKowariMaker(GraphKowariMaker gkm) {
    super(gkm);
  }

  public Model makeModel(Graph graphKowari) {
    return new ModelKowari((GraphKowari) graphKowari);
  }
}
