 ...
 */
public class MulgaraQueryHandlerUnitTest extends AbstractTestQuery {
  ...
  public MulgaraQueryHandlerUnitTest(String name) {
    super(name);
...
//    return new TestSuite(KowariQueryHandlerUnitTest.class);
    ...
    result.addTest(new MulgaraQueryHandlerUnitTest("testBinding2"));
    result.addTest(new MulgaraQueryHandlerUnitTest("testBindingQuery"));
    result.addTest(new MulgaraQueryHandlerUnitTest("testChainedTreeQuery"));
    result.addTest(new MulgaraQueryHandlerUnitTest("testCloseQuery"));
    result.addTest(new MulgaraQueryHandlerUnitTest("testCompositeTreeQuery"));
    result.addTest(new MulgaraQueryHandlerUnitTest("testChainedTreeQuery"));
...
////    result.addTest(new KowariQueryHandlerUnitTest("testConstraintThree"));
    ...
    result.addTest(new MulgaraQueryHandlerUnitTest("testEmptyIterator"));
...
////    result.addTest(new KowariQueryHandlerUnitTest("testExtractConstraint"));
    ...
    result.addTest(new MulgaraQueryHandlerUnitTest("testNodeVariablesA"));
    result.addTest(new MulgaraQueryHandlerUnitTest("testNodeVariablesB"));
...
//    result.addTest(new KowariQueryHandlerUnitTest("testVariableCount"));
  ...
  public void testBinding1() {
    ...
    MulgaraQuery q = new MulgaraQuery();
  ...
  public void testBindingQuery() {
    ...
    /* */
    Query any = new MulgaraQuery().addMatch(Query.ANY, Query.ANY, Query.ANY);
    assertFalse("empty graph, no bindings", eb(empty, any, none).hasNext());
    assertTrue("full graph, > 0 bindings", eb(base, new MulgaraQuery(), none).hasNext());
  }
  ...
  public void testCloseQuery() {
    ...
    Query q = new MulgaraQuery().addMatch(Query.S, Query.P, Query.O);
  ...
  public void testDisconnected() {
    ...
    Query q = new MulgaraQuery(getGraphWithMem("?X ?? foo; ?Y ?? bar"));
  ...
  public void testEmptyIterator() {
    ...
    Query q = new MulgaraQuery().addMatch(X, Y, Z);
  ...
  public void testFor() {
    ...
    ModelMulgara model = new ModelMulgara((GraphMulgara) bookish);
  ...
  public void testGraphQuery() {
    ...
    Query q = new MulgaraQuery(pattern);
  ...
  public void testNodeVariablesA() {
    ...
    Node spoo = node("?spoo");
    Query q = new MulgaraQuery().addMatch(spoo, node("hit"), node("England"));
  ...
  public void testNodeVariablesB() {
    ...
    Query q = new MulgaraQuery().addMatch(spoo, node("hit"), flarn);
    ClosableIterator it = eb(mine, q, new Node[] {
        flarn, spoo});
    assertTrue("tnv: it has a solution", it.hasNext());
  ...
  public void testOneMatch() {
    Query q = new MulgaraQuery().addMatch(X, Query.ANY, Query.ANY);
  ...
  public void testStringResults() {
    ...
    Query q = new MulgaraQuery().addMatch(X, Y, Query.ANY);
    List bindings = ebList(g, q, new Node[] {
        X, Y});
  ...
  public void testTwoGraphs() {
    ...
    Query q = new MulgaraQuery().addMatch("a", X, reads, Y).addMatch("b", Y, inGenre, Z);
  ...
  public void setUp() {
    ...
    try {
      ...
      graphMaker = new GraphMulgaraMaker((LocalJenaSession) sessionTest, serverURI,
