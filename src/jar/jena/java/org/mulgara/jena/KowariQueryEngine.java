 ...
 */
public class KowariQueryEngine extends com.hp.hpl.jena.rdql.QueryEngine {

  /**
   * Logger. This is named after the class.
   */
  private final static Logger logger =
    Logger.getLogger(KowariQueryEngine.class.getName());

  /**
   * Results.
   */
  private KowariResultsIterator iter;
   ...
   */
  public KowariQueryEngine(RdqlQuery q) {
    super(q);
    query = q;
  }
  ...
  public QueryResults exec(ResultBinding startBinding) {
    init();
    iter = new KowariResultsIterator(query, startBinding);
  ...
  static class KowariResultsIterator implements ClosableIterator {
     ...
     */
    KowariResultsIterator(RdqlQuery q, ResultBinding presets) {
      query = q;
      ...
      KowariQuery graphQuery = new KowariQuery();
