 ...
 */
public class GraphMulgaraMakerUnitTest extends AbstractTestGraphMaker {
  ...
  public GraphMulgaraMakerUnitTest(String name) {
...
//    return result;
  ...
  public GraphMaker getGraphMaker() {
    graphMaker = new GraphMulgaraMaker(session, serverURI,
