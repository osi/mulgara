 ...
 */
public class KowariTreeQueryPlan implements TreeQueryPlan {

  /**
   * Logger. This is named after the class.
   */
  private final static Logger logger =
      Logger.getLogger(KowariTreeQueryPlan.class.getName());
  ...
  public KowariTreeQueryPlan(Graph newTarget, Graph newPattern,
