 ...
 */
public class GraphKowariMaker extends BaseGraphMaker {

  /**
   * Logger. This is named after the class.
   */
  private final static Logger logger =
      Logger.getLogger(GraphKowariMaker.class.getName());

  /**
   * The URI node of all Kowari models.
   */
  private static Node kowariModel =
      Node.createURI(Tucana.NAMESPACE + "Model");
   ...
   *   with.
   */
  public GraphKowariMaker(LocalJenaSession newSession,
  ...
  public Graph createGraph(String graphName, boolean strict)
    ...
    try {
      ...
      GraphKowari graph = new GraphKowari(session, graphURI, style);
  ...
  public ExtendedIterator listGraphs() throws JenaException {
    ...
    try {
      ...
      GraphKowari graph = new GraphKowari(session, systemURI);
