 ...
 */
public class MulgaraTransactionHandler extends TransactionHandlerBase {

  /**
   * Logger. This is named after the class.
   */
  private final static Logger logger =
      Logger.getLogger(MulgaraTransactionHandler.class.getName());
   ...
   */
  public MulgaraTransactionHandler(Session newSession) {
    session = newSession;
  }
