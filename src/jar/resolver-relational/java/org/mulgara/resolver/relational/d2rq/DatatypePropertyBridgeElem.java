...
public class DatatypePropertyBridgeElem extends PropertyBridgeElem {
  ...
  public DatatypePropertyBridgeElem(Resolver resolver, ResolverSession session, long propMap, long defModel, D2RQDefn parent) throws LocalizeException, QueryException, TuplesException, GlobalizeException {
    ...
    datatype = getStringObject(map, Constants.datatype, model, true);
    lang = getStringObject(map, Constants.lang, model, true);
  }

  public String toString() {
    return super.toString() + "(column=" + column + ", pattern=" + pattern + ", datatype=" + datatype + ", lang=" + lang + ")";
  }
}
