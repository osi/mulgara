 ...
 *
 * @modified $Date: 2005/01/28 20:07:21 $
 *
 ...
 */
public class ClientBulkUpdateHandler implements BulkUpdateHandler {
   ...
   * @param graph KGraph
   */
  public ClientBulkUpdateHandler(ClientGraph graph) {
  ...
  public void add(Triple[] triples) {
    ...
    graph.performAdd(new ArrayList(Arrays.asList(triples)));
  ...
  public void delete(Triple[] triples) {
    ...
    graph.performDelete(new ArrayList(Arrays.asList(triples)));
