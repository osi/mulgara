...
/**
 * A constraint in the HAVING clause that only returns values which are a given
 * fixed value.
 *
 * @created 2004-08-12
 *
...
public class ConstraintOccurs extends ConstraintHaving {
   ...
   */
  public static final URIReferenceImpl MULGARA_OCCURS =
      new URIReferenceImpl(SpecialPredicates.MULGARA_OCCURS);
   ...
   */
  public ConstraintOccurs(ConstraintElement e0, ConstraintElement e2, ConstraintElement e3) {
    super(e0, MULGARA_OCCURS, e2, e3);
  }
   ...
   * @param e2 The third statement constraint.
   */
  public ConstraintOccurs(ConstraintElement e0, ConstraintElement e2) {
   ...
   */
  public static ConstraintOccurs newLocalConstraintOccurs(
      ConstraintElement e0, ConstraintElement e1,
      ConstraintElement e2, ConstraintElement e3
  ) {
    ConstraintOccurs ci = new ConstraintOccurs(e0, e2, e3 != null ? e3 : Variable.FROM);
    ci.element[1] = e1;
    return ci;
  }
