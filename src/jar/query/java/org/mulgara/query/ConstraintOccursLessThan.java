...
/**
 * A constraint in the HAVING clause that only returns values which are less
 * that a given value.
 *
 * @created 2004-08-12
 *
...
public class ConstraintOccursLessThan extends ConstraintHaving {
   ...
   */
  public static ConstraintOccursLessThan newLocalConstraintOccurs(
      ConstraintElement e0, ConstraintElement e1,
      ConstraintElement e2, ConstraintElement e3
  ) {
    ConstraintOccursLessThan ci = new ConstraintOccursLessThan(e0, e2, e3 != null ? e3 : Variable.FROM);
    ci.element[1] = e1;
    return ci;
  }
   ...
   */
  protected ConstraintOccursLessThan() {
    super();
  }
