...
/**
 * A constraint in the HAVING clause that returns values which are not equal
 * to the given value.
 *
 * @created 2004-08-12
 *
...
public class ConstraintNotOccurs extends ConstraintHaving {
   ...
   * @param e2 The third statement constraint.
   */
  public ConstraintNotOccurs(ConstraintElement e0, ConstraintElement e2) {
   ...
   */
  public static ConstraintNotOccurs newLocalConstraintOccurs(
      ConstraintElement e0, ConstraintElement e1,
      ConstraintElement e2, ConstraintElement e3
  ) {
    ConstraintNotOccurs ci = new ConstraintNotOccurs(e0, e2, e3 != null ? e3 : Variable.FROM);
    ci.element[1] = e1;
    return ci;
  }
