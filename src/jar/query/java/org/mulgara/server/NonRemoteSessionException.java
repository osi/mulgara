...
/**
 * Exception thrown when a {@link SessionFactory} attempts a remote connection on a local model.
 *
 * @created 2004-11-123
 *
 * @author Paul Gearon
...
public class NonRemoteSessionException extends Exception {
   ...
   */
  public NonRemoteSessionException(String message) {
    super(message);
  }
   ...
   */
  public NonRemoteSessionException(String message, Throwable cause) {
    super(message, cause);
  }
}
