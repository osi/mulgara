...
set LOCALPATH=%LIBDIR%\ant-1.6.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\bsf-2.3.0.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\ant-launcher-1.6.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\junit-3.8.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\ant-junit-1.6.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\ant-xslp-1.6.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\ant-apache-bsf-1.6.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\ant-trax-1.6.1.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\js-1.5r3.jar
set LOCALPATH=%LOCALPATH%;%LIBDIR%\ant-nodeps-1.6.1.jar
...
"%JAVA_HOME%\bin\java.exe" -Xms64m -Xmx192m -classpath "%CLASSPATH%;%LOCALPATH%" -Dant.home="%ANT_HOME%" -DJAVAC=%JAVAC% org.apache.tools.ant.Main -buildfile %BUILDFILE% %1 %2 %3 %4 %5 %6 %7 %8 %9
